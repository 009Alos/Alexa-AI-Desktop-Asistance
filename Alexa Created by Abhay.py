...
if __name__ == "__main__":
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            pywhatkit.sendwhatmsg("+917599103632", "You love only shaista", hour, min+1)
            ...
            excelpath=("C:\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs\\Anaconda3 (64-bit)\\Jupyter Notebook (Anaconda3).lnk")
            #Apps=os.listdir(excelpath)
